    ...
    stages {
      ...
      stage('Build docker image '){
                   steps {
                       ...
                       echo "Build a docker image to Backend  assurance "
                       sh ' docker build -t youssefpfe/pfeapps:assurance.$BUILD_ID . '
                       sh "docker images"
                ...
                stage('Push the image to DockerHub '){
                   steps {
                      ...
                      withCredentials([string(credentialsId: 'dockerhub_credential', variable: 'dockerhub_credential')]) {
                         ...
                         sh ' docker push youssefpfe/pfeapps:assurance.$BUILD_ID '
                      }
